...
func _ensure_save_folder_exists() -> void:
	var full_save_folder := _get_absolute_path(LevelshotProjectSettings.get_img_save_folder())
...
func _save_level_image(level_scene_path: String, suffix: String) -> void:
	...
	var save_folder := _get_absolute_path(LevelshotProjectSettings.get_img_save_folder())
